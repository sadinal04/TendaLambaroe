          ...
          <div className={styles.detailSection}>
              ...
              <ul className={styles.featuresList}>
                {product.features.map((feature, i) => (
                  <li key={i} className={styles.featureItem}>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className={styles.featureCheck}>
            ...
            <div className={styles.ctaBox}>
              <div className={styles.ctaInfo}>
                <span className={styles.ctaLabel}>Harga Terbaik</span>
                <p className={styles.ctaNote}>
                  Hubungi kami untuk mendapatkan penawaran harga terbaik, promo spesial,
                  dan konsultasi gratis sesuai kebutuhan Anda.
                </p>
              </div>
              <a
                href={waLink}
              ...
              <p className={styles.waHint}>
                Klik tombol di atas untuk chat langsung dengan tim kami di WhatsApp
              </p>
            </div>
          </div>
        </div>
